...
label_1 = Label(topFrame, text="Temperatur 1")
label_2 = Label(topFrame, text="Temperatur 2")
label_3 = Label(topFrame, text=TempRead1)
label_4 = Label(topFrame, text=TempRead2)
entry_1 = Entry(topFrame)
entry_2 = Entry(topFrame)
label_5 = Label(topFrame, text="Logged at :")
label_6 = Label(topFrame, text=datetime.datetime.now() )
